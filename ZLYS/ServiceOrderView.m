...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightBtn = [[UIBarButtonItem alloc] initWithTitle: @"我的预约" style:UIBarButtonItemStyleBordered target:self action:@selector(myServiceOrderAction:)];
...
- (void)myServiceOrderAction:(id)sender
{
    MyServiceOrderView *myServiceOrder = [[MyServiceOrderView alloc] init];
    [self.navigationController pushViewController:myServiceOrder animated:YES];
}
